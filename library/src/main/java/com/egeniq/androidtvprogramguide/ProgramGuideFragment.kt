...
abstract class ProgramGuideFragment<T> : Fragment(), ProgramGuideManager.Listener,
    ...
    companion object {
        ...
        val TAG: String = ProgramGuideFragment::class.java.name
    }
...
//        setupFilters(view)
     ...
     * Also you can change the display values by overriding the string resources.
     */
    private fun hideFilter(view: View) {
        // Day filter
        val dayFilter = view.findViewById<View>(R.id.programguide_day_filter)
        val timeOfDayFilter = view.findViewById<View>(R.id.programguide_time_of_day_filter)

        dayFilter.visibility=View.GONE
        timeOfDayFilter.visibility = View.GONE
    }
...
//        constraint.applyTo(constraintRoot)
     ...
     */
    protected fun autoScrollToBestProgramme(
